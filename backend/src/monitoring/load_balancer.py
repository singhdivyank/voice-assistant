...
class AgentLoadBalancer:
    ...
    def __init__(self, max_concurrent_agents: Dict[str, int] = None):
    ...
    async def acquire_slot(self, agent_name: str) -> None:
        ...
        if self.current_load[agent_name] >= max_concurrent:
            ...
            logger.debug("Agent %s queued, current load: %d/%d", agent_name, self.current_load[agent_name], max_concurrent)
