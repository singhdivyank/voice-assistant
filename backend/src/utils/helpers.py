...
def _extract_questions(result: str) -> List[str]:
...
def _extract_transcription(result: str) -> Optional[str]:
...
def _extract_review(result: str) -> Dict[str, Any]:
...
def _extract_doctor_response(result: str) -> Dict[str, Any]:
