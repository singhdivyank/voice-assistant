...
from src.api.routes.crew_ai_routes import router as crewai_router
...
async def lifespan(app: FastAPI) -> AsyncGenerator:
    ...
    try:
        from backend.src.core.crew_ai.medical_crew import MedicalAssistantCrew
        # Pre-initialize the crew to validate configuration
        _ = MedicalAssistantCrew()
...
app.include_router(monitoring_router, prefix="/api/v2/monitoring", tags=["monitoring-v2"])
