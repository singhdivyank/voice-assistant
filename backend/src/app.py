...
from src.config.settings import AppConfig, APP_DESCRIPTION
from backend.src.api.routes.diagnosis import DiagnosisService, DiagnosisSession, PatientInfo
from backend.src.api.routes.prescription import PrescriptionService
from src.services.speech import SpeechService
from src.services.translation import TranslationService
from src.utils.consts import Language, Gender
...
class DocJarvis:
    ...
    def perform_consultation(self, language: str, gender: list[str], age: int) -> str:
        """
    ...
    def create_session_context(
        self, language: str, gender: list[str], age: int
    ) -> SessionContext:
